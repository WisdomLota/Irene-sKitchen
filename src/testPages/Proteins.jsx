    ...
    return (
        ...
        <div className="text-irene-400 bg-irene-100 h-screen">
            ...
            <div className="flex justify-around px-16 py-4">
                ...
                <p className="text-center bg-irene-200 rounded-full px-6 py-1 hover:border border-irene-400" onClick={()=> navigate('/proteins')}>Proteins</p>
            ...
            <div className="bg-irene-200 px-24 py-6 space-y-2">
                <div>
                    <p className="text-center font-bold text-lg">Tray Price: 5500</p>
                </div>
