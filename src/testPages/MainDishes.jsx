    ...
    return (
        ...
        <div className="text-irene-400 bg-irene-100 h-screen">
            ...
            <div className="flex justify-around px-16 py-4">
                <p className="text-center bg-irene-200 rounded-full px-6 py-1 hover:border border-irene-400" onClick={()=> navigate('/main-dishes')}>Main Dishes</p>
                ...
                <p className="text-center border border-irene-400 rounded-full px-6 py-1 hover:bg-irene-200" onClick={()=> navigate('/munchables')}>Munchables</p>
            ...
            <div className="grid grid-flow-col justify-stretch px-20 py-4 space-x-4 lg:space-x-40">
                ...
                <div className="mb-8">
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <div className="flex justify-between">
                            <p>Mixed Rice (Fried and Mixed)</p>
                            <p className="text-center border border-irene-400 rounded-full px-6 py-1 hover:bg-irene-200">Preview</p>
                        </div>
                        <div className="flex justify-between">
                            <p>Chips</p>
            ...
            <div className="bg-irene-200 px-24 py-6 space-y-4">
                <div>
                    <p className="text-center font-bold text-lg">Tray Price: 3500</p>
                </div>
                <div className="flex justify-between space-x-4">
                    <div className="flex space-x-8">
                        ...
                        <div className="flex space-x-6 border border-irene-400 rounded-full px-4 py-1 justify-center items-center">
                            <p className="px-6 py-1 rounded-full bg-irene-300">Jollof Rice</p>
