    ...
    return (
        ...
        <div className="bg-irene-100 text-irene-400 overflow-x-hidden lg:h-screen">
            ...
            <div className="flex justify-around px-16 py-4 mb-4">
                ...
                <p className="text-center bg-irene-200 rounded-full px-6 py-1 hover:border border-irene-400" onClick={()=> navigate('/delivered-orders')}>Delivered</p>
            </div>

            <div className="flex justify-center items-center">
                <p className="font-bold text-lg mb-4">Orders Delivered</p>
            </div>
