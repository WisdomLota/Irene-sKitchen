    ...
    return (
        ...
        <div className="text-irene-400 bg-irene-100">
                ...
                <div className="border border-irene-400 rounded-2xl px-4 py-6 space-y-2 lg:space-y-12">
                    ...
                    <div className="space-y-2 lg:grid grid-flow-col justify-stretch space-x-1">
                        <div className="flex border border-irene-400 rounded-full px-4 py-1 justify-center items-center space-x-4">
                            <p className="text-center border border-irene-400 rounded-full px-6 py-1 w-1/2">Jollof Rice</p>
                            <p className="py-1 text-center">4</p>
                        </div>
                        <div className="flex border border-irene-400 rounded-full px-4 py-1 justify-center items-center space-x-4">
                            <p className="text-center border border-irene-400 rounded-full px-6 py-1 w-1/2">Chicken</p>
                            <p className="py-1 text-center">4</p>
                        </div>
                        <div className="flex border border-irene-400 rounded-full px-4 py-1 justify-center items-center space-x-4">
                            <p className="text-center border border-irene-400 rounded-full px-6 py-1 w-1/2">Sponge Cake</p>
                    ...
                    <div className="flex justify-center items-center mt-2">
                        <div className="flex border border-irene-400 rounded-full justify-center items-center space-x-4 w-full lg:w-1/3 py-1 ">
                            <p className="text-center border border-irene-400 rounded-full px-4 py-1 w-1/2">Coke</p>
                            <p className="py-1 text-center">1</p>
                        </div>
                    </div>   
                </div>
            ...
            <div className="flex justify-center items-center mt-8">
                <p className="font-bold text-lg">Patron's Information</p>
            </div>
            ...
            <div className="flex justify-center items-center p-4">
                <p className="px-12 py-1 font-bold rounded-full border border-irene-400 hover:bg-irene-200">Cancel my Order</p>
            </div>
        </div>
        </>
    )
